...
You can then execute your native executable with: `./build/demo-quarkus-3-1.0-SNAPSHOT-runner`
...
- Infinispan Client ([guide](https://quarkus.io/guides/infinispan-client)): Connect to the Infinispan data grid for
  distributed caching
